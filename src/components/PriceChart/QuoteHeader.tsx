        ...
        <div className="flex items-baseline gap-3 font-mono">
          ...
          {quote.preMarket && (
            <span className="text-xs text-gray-400">
              盘前 {formatNumber(quote.preMarket.price)} ({quote.preMarket.changePercent >= 0 ? "+" : ""}{formatNumber(quote.preMarket.changePercent)}%)
            </span>
          )}
          {quote.postMarket && (
            <span className="text-xs text-gray-400">
              盘后 {formatNumber(quote.postMarket.price)} ({quote.postMarket.changePercent >= 0 ? "+" : ""}{formatNumber(quote.postMarket.changePercent)}%)
            </span>
          )}
        </div>
      </div>
